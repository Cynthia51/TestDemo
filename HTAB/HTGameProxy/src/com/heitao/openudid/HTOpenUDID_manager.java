...
public class HTOpenUDID_manager implements ServiceConnection{
	...
	private HTOpenUDID_manager(Context context) {
	...
	public static void sync(Context context) {
		...
		HTOpenUDID_manager manager = new HTOpenUDID_manager(context);
