...
public class HTPOpenUDID_manager implements ServiceConnection{
	...
	private HTPOpenUDID_manager(Context context) {
	...
	public static void sync(Context context) {
		...
		HTPOpenUDID_manager manager = new HTPOpenUDID_manager(context);
